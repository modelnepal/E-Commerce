<div class="offcanvas offcanvas-end" title="cart" data-bs-scroll="true" tabindex="-1" id="offcanvasCart">
      ...
      <div
        ...
        <div class="d-flex align-items-center my-3 my-sm-0">
          <a href="<?php echo esc_url(home_url()); ?>">
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo.svg" alt="logo" class="img-fluid">
          </a>
        </div>
